                        ...
                        <div className="col-lg-8 mb-3">
                            <div className="rakeBack h-100">
                                <div className="borderColor position-relative h-100">
                                    ...
                                    <div
                                        className="row mx-0 align-items-center justify-content-center flex-wrap position-relative">
                                        <div className={"col-lg-6 mb-1"}>
                                            <div className="h2 mb-2">RAKEBACK</div>
                                            <p className={"mb-2"}>Increase your level to earn more coins. You currently
                                                earn <span>0.25%</span> rakeback on all bets.</p>
                                        </div>
                                        <div className="col-lg-6 mb-1">
                            ...
                            <div className="freeCoins h-100">
                                <div className="borderColor position-relative h-100">
                                    ...
                                    <div className="position-relative">
                                        ...
                                        <div className="p">
                                            You can open one of your unlocked
                                            cases <span>daily</span> to earn coins.
                                        </div>
                                    </div>
