...
import '../css/userDetailsLayout.css'
                    ...
                    <div className="row mx-0 mb-5">
                        <div className="col-lg-8">
                            <div className="profileWrapper d-flex gap-3">
                                <img src={avatar}/>
                                <div>
                                    <h2>JONAS VIAENE <span>#123450</span></h2>
                                    <p><span>Joined</span> September 11th 2024</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="row mx-0 mb-5">
                        <div className="col-lg-12">
                            <div className="d-flex justify-content-between">
                                <div className="number d-flex align-items-end gap-3 mb-0"><span className={"bg"}>1</span> <span>Squire</span> </div>
                                <div className="number">XXXXX/XXXXX XP</div>
                                <div className="number d-flex align-items-end gap-3 mb-0"> <span>Squire</span> <span className={"bg"}>2</span></div>
                            </div>
                            <CustomProgressBar/>
