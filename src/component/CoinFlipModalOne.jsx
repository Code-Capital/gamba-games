...
import "../css/coinFlipModalOne.css";
                    ...
                    <Modal.Body className={"coinFlipModalBody"}>
                        <div className="d-flex align-items-center justify-content-between head mb-3 flex-wrap">
                            <div className={"d-flex align-items-center gap-3 py-1"}>
                                ...
                                <div className="h2">CREATE<span>FLIP</span></div>
                                <div className={"text"}>
                            ...
                            <div className={"d-flex align-items-center gap-3 py-1"}>
                                <div className={"value text-center"}>
                                    ...
                                    <span className={"d-block"}><img className={"me-2"}
                                                                     src={gameToken}/><span>2,856.90</span></span>
                                </div>
                                <div className="img">
                                    ...
                                    <div className="position-relative">
                                        ...
                                        <div className="cardItem">
                                            <div
                                                ...
                                                <img src={item.icon}/>
                                                <span>{item.name}</span>
                                                <div className="value d-flex align-items-center"><img className={"me-2"}
                                                                                                      src={gameToken}/><span>{item.value}</span>
                                                </div>
                                            </div>
                                            <div
                                                className="checked d-flex align-items-center justify-content-center position-absolute">
                        ...
                        <div className="d-flex align-items-center justify-content-between foot mt-3 flex-wrap">
                            <div className={"d-flex align-items-center gap-3  py-1"}>
                                <div className={"value text-center"}>
                                    <span className={"d-block"}><span className={"text"}>Minimum deposit of</span><img
                                        className={"mx-2"} src={gameToken}/><span>1.00</span></span>
                                </div>
                            </div>
                            <div className={"d-flex align-items-center gap-3 flex-wrap py-1"}>
                                <div className={"value text-center"}>
                                    <span className={"d-block"}> <img className={"me-2"}
                                                                      src={gameToken}/><span>1.00</span></span>
                                </div>
                                <img src={whiteCoin} alt="Game Token"/>
                                <img src={blackCoin} alt="Game Token"/>
                                <button className={"btn h-100 px-5"} onClick={handleCreateClick} >CREATE</button>
                            </div>
                        </div>
                    </Modal.Body>
                </div>
