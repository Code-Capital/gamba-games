            ...
            <div className="">
                <div className="row mx-0 align-items-end mt-3">
                    ...
                    <div className="col-md-6 col-lg-3 mb-3">
                        <div className="wrapper">
                            ...
                            <div className="name text-center py-2 text-uppercase ">
                                RUST
                            </div>
                        </div>
                    </div>
                ...
                <div className="row mx-0">
                    <div className="col-lg-12 mb-2">
                        <div className="h2 mb-0">Crypto <span className={"ms-2"}>+30%</span></div>
                    </div>
                ...
                <div className="row mx-0">
                    <div className="col-lg-12 mb-2">
                        <div className="h2 mb-0">Gift card <span className={"ms-2"}>+30%</span></div>
                    </div>
                    <div className="col-md-6 col-lg-3 mb-3">
                        <div className="wrapper">
