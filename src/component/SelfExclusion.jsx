            ...
            <div className="selfExclusion pt-5">
                <div className="row mx-0">
                    <div className="col-lg-6 mb-5">
                        ...
                        <p>
                            At GambaGames, we prioritize responsible gaming. With our self-exclusion option, you can
                            temporarily pause wagering, deposits, and certain features. Withdrawals and site access
                            remain available. Keep in mind, self-exclusion is irreversible. For a permanent ban, contact
                            our support team. Play responsibly!
                        </p>
                    </div>
                    <div className="col-lg-12">
                        ...
                        <div className="d-flex align-items-center justify-content-between gap-3 mb-3">
                            {durations.map((duration, index) => (
                                <button key={index} className={`btn p-3 flex-grow-1 ${selectedDuration === duration ? "active" : ""}`} onClick={() => handleDurationSelect(duration)}>
                                    {duration}
                                </button>
                            ))}
                        </div>
