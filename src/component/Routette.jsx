                ...
                <div className="row mx-0">
                    ...
                    <div className="col-lg-12">
                        <div className="routette position-relative h-100">
                            <div
                                className="itemsWrapper align-items-center d-flex justify-content-center overflow-x-scroll"
                                ref={itemsWrapperRef}>
                                {elements.map(el => {
                                    return (
                                        <>
