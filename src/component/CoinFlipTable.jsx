              ...
              <tbody>
                {data.map((item, index) => (
                  <tr key={index}>
                    ...
                    <td>
                      <img src={gameToken} alt='Game token' />
                      <span className='ms-2'>{item.total}</span>
                    </td>
                    <td className={'buttons d-flex gap-3 align-items-center'}>
                      <div className='position-relative'>
                        ...
                        <button onClick={() => handleShow(index)} className={`text-uppercase btn ${item.buttonClass} px-4`}>
                          {item.buttonText}
                        </button>
                      </div>
                      <div className=''>
