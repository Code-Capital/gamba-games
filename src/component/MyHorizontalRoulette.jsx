...
function MyHorizontalRoulette({ show, handleClose }) {
  return (
    <Modal className={'spinnerModal'} show={show} onHide={handleClose} size='lg' aria-labelledby='contained-modal-title-vcenter' centered>
      <div className=''>
        ...
        <Modal.Body>
          ...
          <div className='position-relative'>
            <div className='spinnerWrapper p-4 align-items-center d-flex justify-content-center overflow-x-scroll '>
              ...
              <div className='singleItem'>
                ...
                <div className='text'>Item name here</div>
                <div className='price d-flex gap-1 justify-content-center align-items-center justify-content-center'>
                  <img className={'icon'} src={icon11} />
                  <span>1.00</span>
                </div>
              </div>
          ...
          <div className='d-flex align-items-center justify-content-between  flex-wrap gap-3 pt-4 pb-3'>
            <div className='text '>Won items get converted to coins immediately.</div>
