        ...
        <div className='container px-0'>
            ...
            <div className='col-lg-12 mb-3'>
              <div className='affiliateCard'>
                <div className='borderColor position-relative'>
                  ...
                  <div className='row mx-0 justify-content-between flex-wrap position-relative align-items-center'>
                    <div className='col-lg-7'>
                      <div className='h1 mb-2'>
                        INVITE FRIENDS TO EARN <br />
                        <span>FREE COINS</span>
                      </div>
                      <p>
                        Join us as an affiliate, earn with every referral! As they play and deposit, watch your earnings soar. More
                        referrals mean higher ranks with more earnings. Share your code or link and start earning!
                      </p>
                    </div>
                    <div className='col-lg-4'>
                      <div className='h5 d-flex align-items-end gap-2 mb-3'>
                        <span>YOUR CODE</span>
                        <CopyIcon />
                        <span>copy link</span>
                      </div>
                      <div className='d-flex align-items-center gap-2'>
                        <input type='text' className={'form-control form-control-lg'} placeholder={'Referral Code'} />
                ...
                <div className='borderColor position-relative'>
                  ...
                  <div className='d-flex gap-3 mb-0 position-relative'>
                    ...
                    <div className='content'>
                      <div className={'h6 d-flex align-items-center gap-2 justify-content-center mb-0'}>
                        <img src={icon13} />
                        <span>NOBLE</span>
                        <img src={icon13} />
                      </div>
                      ...
                      <div className='d-flex align-items-center gap-2 content mb-0 flex-grow-1'>
                        ...
                        <div className={'progressWapper'}>
                          <div className={'d-flex align-items-end gap-2 text mb-1'}>
                            <img src={gameToken} /> <span>200,000.00</span>
                            <img src={gameToken} />
                          </div>
                          <div>
                            <ProgressBar now={45} />
          ...
          <div className='row mx-0 align-items-center'>
            <div className='col-lg-6 mb-3'>
              <div className='h2 mb-0'>
                YOUR AFFILIATE <span>SUMMARY</span>
              </div>
            </div>
            <div className='col-lg-6 mb-3'>
              <div className={'p mb-0'}>
                Affiliate pay-out is calculated based on the amount of cash deposits that are made by referrals that used your code to make
                the deposit.
              </div>
            </div>
          </div>
          <div className='row mx-0 align-items-start mb-5'>
            ...
            <div className='col-lg-3 mb-3'>
              ...
              <div className='claim py-2'>CLAIM</div>
            </div>
          </div>
          <Stats />
          <Refree />
