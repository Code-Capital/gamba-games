  ...
  return (
    <div>
      <div className='footer'>
                ...
                <div className='borderColor position-relative'>
                  ...
                  <div className='d-flex align-items-center justify-content-center gap-4 flex-wrap position-relative'>
                    ...
                    <div className='brand text-center'>
                      ...
                      <div className={'text'}>Seize the throne and start your legacy today!</div>
                    </div>
                    <img src={logo} />
                  </div>
                </div>
          ...
          <div className='row mx-0'>
            <div className='col-lg-4 col-md-12 mb-3'>
              <div className='text'>
                ...
                GambaGames is owned and operated by Gambagames Entertainment Ltd located at Streetname, 77, 7rd Floor, Office 777, 7777, Las
                Vegas, USA
              </div>
              <ul className={'list-unstyled pt-4'}>
                <li className={'d-flex align-items-center gap-1 mb-2'}>
                  <img src={mail} />
                  <span>Gambagames@gmail.com</span>
                </li>
        ...
        <div className='text-center copyrights'>© 2024 - 2024 Gambagames.gg All Rights Reserved</div>
      </div>
    </div>
  );
}
