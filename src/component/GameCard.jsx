        ...
        <div className='row mx-0 mt-5'>
          ...
          {games.map((game, index) => (
            <div key={index} className={`col-lg-${game.columnSize} mb-3`}>
              <div
                className='game position-relative'
                onMouseEnter={() => handleMouseEnter(game.videoRef)}
                onMouseLeave={() => handleMouseLeave(game.videoRef)}
              >
                <div className='video-container'>
                  <video ref={game.videoRef} autoPlay muted poster={game.poster} playsInline className='video-element' draggable='true'>
