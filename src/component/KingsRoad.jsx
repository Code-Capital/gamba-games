...
import MyHorizontalRoulette from "./MyHorizontalRoulette.jsx";
                            ...
                            <div className="d-flex align-items-center justify-content-center gap-5">
                                {chestsData.map(chest => (
                                    <div className="box text-center" key={chest.id}>
                                        <div className="imgBox"><img src={chest.image} className={"mb-4"} /></div>
                                        ...
                                        <h5>UNLOCKS AT LVL <span>{chest.level}</span></h5>
                                    </div>
                                ))}
                            </div>
                        </div>
