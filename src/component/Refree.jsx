                ...
                <tbody>
                  {refree.map((refree, index) => (
                    <tr key={index}>
                      <td className={'name'}>
                        <img src={refreeIcon} />
                        <span className='ms-1 '> {refree.name}</span>
                      </td>
                      <td>
                        <img src={gameToken} />
                        <span className='ms-2'> {refree.deposit}</span>
                      </td>
                      <td>
                        <img src={gameToken} />
                        <span className='ms-2'>{refree.commission}</span>
                      </td>
                      <td>
                        <span>{refree.date}</span>
                        <img className='mx-2' src={gameToken} />
                        <span>{refree.amount}</span>
                      </td>
          ...
          <div className='col-lg-6 mx-auto px-0 mt-5'>
            <div className='conditions py-5'>
              ...
              <div className='d-flex align-items-start gap-3 mb-3'>
                ...
                <span>
                  Each player who uses your code will unlock the rakeback feature and unlock the thrilling chance to snag not one, but two
                  epic rewards.
                </span>
              </div>
              <div className='d-flex align-items-start gap-3 mb-3'>
