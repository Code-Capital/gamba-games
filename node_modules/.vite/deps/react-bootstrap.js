import {
  ...
  alignPropType,
  useUncontrolledProp
} from "./chunk-QY23PHIZ.js";
import {
  ProgressBar_default
} from "./chunk-HV6DCOPB.js";
import {
  ...
  Popover_default,
  useTimeout
} from "./chunk-Y63TJD34.js";
import "./chunk-KCFZ7QU2.js";
import {
  Tooltip_default
} from "./chunk-PUEFBIQG.js";
import {
  CardHeaderContext_default,
  NavItem_default,
  Nav_default,
  Nav_default2
} from "./chunk-E7Z2OHL6.js";
import {
  Anchor_default,
  NavLink_default,
  TabContext_default,
  useNavItem
} from "./chunk-M2M7ZY3S.js";
import {
  useCallbackRef
} from "./chunk-3CRLCUNE.js";
import {
  Button_default
} from "./chunk-RQILQVP7.js";
import "./chunk-JHM2CLSI.js";
import {
  Col_default,
...
} from "./chunk-GALNHDRO.js";
import {
  SelectableContext_default,
  makeEventKey
} from "./chunk-ZQSAU2CP.js";
import {
  require_browser,
...
var InputGroup = React37.forwardRef(({
  ...
  return (0, import_jsx_runtime39.jsx)(InputGroupContext_default.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime39.jsx)(Component, {
      ref,
      ...props,
...
var Modal = React45.forwardRef(({
  ...
  const renderBackdrop = (0, import_react10.useCallback)((backdropProps) => (0, import_jsx_runtime47.jsx)("div", {
    ...backdropProps,
...
var PageItem = React46.forwardRef(({
  active = false,
  disabled = false,
  className,
  style,
  ...
  return (0, import_jsx_runtime48.jsx)("li", {
    ref,
    style,
    className: (0, import_classnames43.default)(className, "page-item", {
      active,
      disabled
    }),
    children: (0, import_jsx_runtime49.jsxs)(Component, {
      className: (0, import_classnames43.default)("page-link", linkClassName),
      style: linkStyle,
      ...props,
...
function createButton(name, defaultValue, label = name) {
  const Button = React46.forwardRef(({
    children,
    ...props
...
var Pagination = React47.forwardRef(({
  ...
  return (0, import_jsx_runtime50.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames44.default)(className, decoratedBsPrefix, size2 && `${decoratedBsPrefix}-${size2}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames45.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size2 && `${bsPrefix}-${size2}`, bg && `bg-${bg}`)
  };
}
...
var PlaceholderButton = React48.forwardRef((props, ref) => {
...
var Placeholder = React49.forwardRef(({
  as: Component = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
var Ratio = React50.forwardRef(({
  ...
  return (0, import_jsx_runtime53.jsx)("div", {
    ...
    children: React50.Children.only(children)
  });
});
...
var Row = React51.forwardRef(({
  ...
  return (0, import_jsx_runtime54.jsx)(Component, {
    ref,
    ...props,
    className: (0, import_classnames47.default)(className, decoratedBsPrefix, ...classes)
  });
});
Row.displayName = "Row";
var Row_default = Row;
...
var SplitButton = React53.forwardRef(({
  id,
  bsPrefix,
  size: size2,
  variant,
  ...
  flip,
  ...props
}, ref) => (0, import_jsx_runtime57.jsxs)(Dropdown_default, {
  ref,
  ...props,
  as: ButtonGroup_default,
  children: [(0, import_jsx_runtime56.jsx)(Button_default, {
    size: size2,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime56.jsx)(Dropdown_default.Toggle, {
    split: true,
    id,
    size: size2,
    variant,
  ...
  }), (0, import_jsx_runtime56.jsx)(Dropdown_default.Menu, {
    role: menuRole,
    renderOnMount: renderMenuOnMount,
    rootCloseEvent,
    flip,
...
function useTabPanel(_ref) {
  ...
  const context3 = (0, import_react11.useContext)(TabContext_default);
  if (!context3)
...
var TabPanel = React55.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component = "div"
    ...
    return (0, import_jsx_runtime59.jsx)(TabContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime59.jsx)(SelectableContext_default.Provider, {
        value: null,
        children: (0, import_jsx_runtime59.jsx)(Transition, {
          in: isActive,
          onEnter,
          onEntering,
          onEntered,
          ...
          mountOnEnter,
          unmountOnExit,
          children: (0, import_jsx_runtime59.jsx)(Component, Object.assign({}, tabPanelProps, {
            ref,
            hidden: !isActive,
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react12.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = (0, import_react12.useMemo)(() => ({
    onSelect,
    activeKey,
    transition,
...
var TabContainer = ({
  transition,
  ...props
}) => (0, import_jsx_runtime61.jsx)(Tabs_default, {
  ...props,
...
var TabContent = React58.forwardRef(({
  className,
  bsPrefix,
  as: Component = "div",
  ...props
...
var TabPane = React59.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
  ...
  return (0, import_jsx_runtime63.jsx)(TabContext_default.Provider, {
    value: null,
    children: (0, import_jsx_runtime63.jsx)(SelectableContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime63.jsx)(Transition, {
        in: isActive,
        onEnter,
        onEntering,
        onEntered,
...
var Table = React60.forwardRef(({
  ...
  const classes = (0, import_classnames52.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size2 && `${decoratedBsPrefix}-${size2}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
  const table = (0, import_jsx_runtime64.jsx)("table", {
    ...props,
    className: classes,
    ref
  });
...
var ToastFade = React62.forwardRef((props, ref) => (0, import_jsx_runtime67.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React63.createContext({
...
var ToastHeader = React64.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
  ...
  const context3 = (0, import_react13.useContext)(ToastContext_default);
...
var ToastBody = React65.forwardRef(({
  className,
  bsPrefix,
  as: Component = "div",
  ...props
...
var Toast = React66.forwardRef(({
  ...
  const delayRef = (0, import_react14.useRef)(delay);
  const onCloseRef = (0, import_react14.useRef)(onClose);
  ...
  const autohideFunc = (0, import_react14.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react14.useMemo)(() => ({
    onClose
  }), [onClose]);
...
var ToastContainer = React67.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
...
var noop = () => void 0;
var ToggleButton = React68.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
...
var ToggleButtonGroup = React69.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
