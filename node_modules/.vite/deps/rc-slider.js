...
var Handle = React5.forwardRef(function(props, ref) {
  var _cls, _getIndex;
  var prefixCls = props.prefixCls, value = props.value, valueIndex = props.valueIndex, onStartMove = props.onStartMove, style = props.style, render = props.render, dragging = props.dragging, onOffsetChange = props.onOffsetChange, onChangeComplete = props.onChangeComplete, restProps = _objectWithoutProperties(props, _excluded);
  ...
  var handleNode = React5.createElement("div", _extends({
    ref,
    className: (0, import_classnames.default)(handlePrefixCls, (_cls = {}, _defineProperty(_cls, "".concat(handlePrefixCls, "-").concat(valueIndex + 1), range), _defineProperty(_cls, "".concat(handlePrefixCls, "-dragging"), dragging), _cls), classNames3.handle),
...
function useOffset(min, max, step, markList, allowCross, pushable) {
  var formatRangeValue = React8.useCallback(function(val) {
    var formatNextValue = isFinite(val) ? val : min;
    formatNextValue = Math.min(max, val);
    formatNextValue = Math.max(min, formatNextValue);
    return formatNextValue;
  }, [min, max]);
  var formatStepValue = React8.useCallback(function(val) {
    if (step !== null) {
  ...
  var formatValue = React8.useCallback(function(val) {
...
function Mark(props) {
  ...
  var _React$useContext = React9.useContext(context_default), min = _React$useContext.min, max = _React$useContext.max, direction = _React$useContext.direction, includedStart = _React$useContext.includedStart, includedEnd = _React$useContext.includedEnd, included = _React$useContext.included;
...
function Marks(props) {
  ...
  return React10.createElement("div", {
    ...
    return React10.createElement(Mark, {
      key: value,
...
function Dot(props) {
  ...
  var _React$useContext = React11.useContext(context_default), min = _React$useContext.min, max = _React$useContext.max, direction = _React$useContext.direction, included = _React$useContext.included, includedStart = _React$useContext.includedStart, includedEnd = _React$useContext.includedEnd;
...
function Steps(props) {
  ...
  var _React$useContext = React12.useContext(context_default), min = _React$useContext.min, max = _React$useContext.max, step = _React$useContext.step;
  var stepDots = React12.useMemo(function() {
  ...
  return React12.createElement("div", {
    ...
    return React12.createElement(Dot, {
      prefixCls,
      key: dotValue,
      value: dotValue,
      style,
...
function Track(props) {
  ...
  var _React$useContext = React13.useContext(context_default), direction = _React$useContext.direction, min = _React$useContext.min, max = _React$useContext.max, disabled = _React$useContext.disabled, range = _React$useContext.range, classNames3 = _React$useContext.classNames;
  ...
  var className = replaceCls || (0, import_classnames4.default)(trackPrefixCls, (_cls = {}, _defineProperty(_cls, "".concat(trackPrefixCls, "-").concat(index + 1), index !== null && range), _defineProperty(_cls, "".concat(prefixCls, "-track-draggable"), onStartMove), _cls), classNames3.track);
...
function Tracks(props) {
  ...
  var _React$useContext = React14.useContext(context_default), included = _React$useContext.included, range = _React$useContext.range, min = _React$useContext.min, styles = _React$useContext.styles, classNames3 = _React$useContext.classNames;
  var trackList = React14.useMemo(function() {
    if (!range) {
      if (values.length === 0) {
        return [];
      }
  ...
  var tracksNode = null;
  if (classNames3.tracks || styles.tracks) {
    tracksNode = React14.createElement(Track, {
      index: null,
      prefixCls,
  ...
  return included ? React14.createElement(React14.Fragment, null, tracksNode, trackList.map(function(_ref, index) {
    var start = _ref.start, end = _ref.end;
    return React14.createElement(Track, {
      index,
      prefixCls,
