...
function useDropdownMenu(options = {}) {
  const context2 = (0, import_react2.useContext)(DropdownContext_default);
  const [arrowElement, attachArrowRef] = useCallbackRef();
  const hasShownRef = (0, import_react2.useRef)(false);
  const {
    flip,
    offset,
    rootCloseEvent,
...
function $b5e257d569688ac6$var$LegacySSRProvider(props) {
  let cur = (0, import_react3.useContext)($b5e257d569688ac6$var$SSRContext);
  let counter = $b5e257d569688ac6$var$useCounter(cur === $b5e257d569688ac6$var$defaultContext);
  let [isSSR, setIsSSR] = (0, import_react3.useState)(true);
  ...
  return (0, import_react3.default).createElement($b5e257d569688ac6$var$SSRContext.Provider, {
    value
  }, (0, import_react3.default).createElement($b5e257d569688ac6$var$IsSSRContext.Provider, {
    value: isSSR
  }, props.children));
}
var $b5e257d569688ac6$var$warnedAboutSSRProvider = false;
function $b5e257d569688ac6$export$9f8ac96af4b1b2ae(props) {
  if (typeof (0, import_react3.default)["useId"] === "function") {
    if (!$b5e257d569688ac6$var$warnedAboutSSRProvider) {
      console.warn("In React 18, SSRProvider is not necessary and is a noop. You can remove it from your app.");
      $b5e257d569688ac6$var$warnedAboutSSRProvider = true;
    }
    return (0, import_react3.default).createElement((0, import_react3.default).Fragment, null, props.children);
  }
  return (0, import_react3.default).createElement($b5e257d569688ac6$var$LegacySSRProvider, props);
}
...
function $b5e257d569688ac6$export$535bd6ca7f90a273() {
  if (typeof (0, import_react3.default)["useSyncExternalStore"] === "function")
    return (0, import_react3.default)["useSyncExternalStore"]($b5e257d569688ac6$var$subscribe, $b5e257d569688ac6$var$getSnapshot, $b5e257d569688ac6$var$getServerSnapshot);
...
function useDropdownItem({
  ...
  const onSelectCtx = (0, import_react5.useContext)(SelectableContext_default);
  const navContext = (0, import_react5.useContext)(NavContext_default);
  const {
    activeKey
  } = navContext || {};
...
function Dropdown({
  ...
  const context2 = (0, import_react6.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
...
function useWrappedRefWithWarning(ref, componentName) {
  if (false)
    return ref;
  const warningRef = (0, import_react7.useCallback)((refValue) => {
...
var DropdownMenu2 = React12.forwardRef(({
  ...
  let alignEnd = false;
  const isNavbar = (0, import_react8.useContext)(NavbarContext_default);
  const prefix = useBootstrapPrefix(bsPrefix, "dropdown-menu");
  const {
    align: contextAlign,
    drop,
    isRTL
  } = (0, import_react8.useContext)(DropdownContext_default2);
  align = align || contextAlign;
  const isInputGroup = (0, import_react8.useContext)(InputGroupContext_default);
  const alignClasses = [];
  if (align) {
...
//# sourceMappingURL=chunk-QY23PHIZ.js.map
